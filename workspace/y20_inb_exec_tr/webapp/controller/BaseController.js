sap.ui.define([
	...
	return Controller.extend("y20_inb_exec_tr.controller.BaseController", {
		...
		checkWhNumberAndWorkstation: function  checkWhNumberAndWorkstation() {
			...
			if (!this.whNumber || !this.workStation) {
			  ...
			  location.replace("".concat(appLocation, "?appname=ptwy_tr&").concat(search.substring(1, search.length)));
			}
		  },
		...
		_getMessagePopover: function () {
			...
			if (!this._oMessagePopover) {
				this._oMessagePopover = sap.ui.xmlfragment(this.getView().getId(),
					"y20_inb_exec_tr.view.MessagePopover", this);
