sap.ui.define([
	...
	return Controller.extend("Y20_OBD_TR_PRP1.controller.BaseController", {
		whNumber: undefined,
		...
		checkWhNumberAndWorkstation: function  checkWhNumberAndWorkstation() {
			...
			if (!this.whNumber || !this.workStation) {
			  ...
			  location.replace("".concat(appLocation, "?appname=obd_tr_prp1&").concat(search.substring(1, search.length)));
			}
		  },
		...
		_getMessagePopover: function () {
			...
			if (!this._oMessagePopover) {
				this._oMessagePopover = sap.ui.xmlfragment(this.getView().getId(),
					"Y20_OBD_TR_PRP1.view.MessagePopover", this);
