sap.ui.define([
	...
	return Controller.extend("y20_as_ptwy.controller.BaseController", {
		whNumber: undefined,
		...
		checkWhNumberAndWorkstation: function  checkWhNumberAndWorkstation() {
			...
			if (!this.whNumber || !this.workstation) {
			  ...
			  location.replace("".concat(appLocation, "?wsMode=PTWY&").concat(search.substring(1, search.length)));
			 } 
		  },
		...
		_getMessagePopover: function () {
			...
			if (!this._oMessagePopover) {
				this._oMessagePopover = sap.ui.xmlfragment(this.getView().getId(),
					"y20_as_ptwy.view.MessagePopover", this);
