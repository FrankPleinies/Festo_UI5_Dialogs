sap.ui.define([
	...
	return Controller.extend("y20_inb_exec_pa.controller.BaseController", {
		whNumber: undefined,
		...
		checkWhNumberAndWorkstation: function  checkWhNumberAndWorkstation() {
			...
			if (!this.whNumber || !this.workStation) {
			  ...
			  location.replace("".concat(appLocation, "?appname=ptwy_pa&").concat(search.substring(1, search.length)));
			}
		  },
		...
		_getMessagePopover: function () {
			...
			if (!this._oMessagePopover) {
				this._oMessagePopover = sap.ui.xmlfragment(this.getView().getId(),
					"y20_inb_exec_pa.view.MessagePopover", this);
