sap.ui.define([
    ...
    return Object.extend("zswl_as_cons.controller.ASController", {
		...
		readHU: function readHU(huident) {
			...
			oModel.read("/ASBinSet(Lgnum='" + lgnum + "',BinID='" + huident + "')", {
				urlParameters: {
					"$expand": "ASBin_ASBinContentNav,ASBin_BuildGridNav"
				},
			success: function (oData, response) {
		...
		buildGrid: function buildGrid(invisible) {
			...
			var rows = 2;//modelHU.Rows;
			var cols = 2;//modelHU.Columns;
