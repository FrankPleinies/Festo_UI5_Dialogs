...
sap.ui.define(["./Base.controller", "../model/formatter", "sap/ui/model/json/JSONModel", "sap/ui/core/Fragment", "sap/ui/core/BusyIndicator"], function (Controller, formatter, JSONModel, Fragment, BusyIndicator) {
  ...
  return Controller.extend("y20_out_pick_s.controller.MainScreen", {
    ...
    setConsts: function setConsts() {
      var _RBGOne, _RBGTwo, _RBGThree;

      var resourceBundle = this.getView().getModel("i18n").getResourceBundle();
      this.radioButtonGroupEnums = {
        RBGOne: (_RBGOne = {}, _defineProperty(_RBGOne, resourceBundle.getText("noUseResource"), false), _defineProperty(_RBGOne, resourceBundle.getText("yes"), true), _RBGOne),
        RBGTwo: (_RBGTwo = {}, _defineProperty(_RBGTwo, resourceBundle.getText("autoAssign"), 0), _defineProperty(_RBGTwo, resourceBundle.getText("onlyCons"), 1), _defineProperty(_RBGTwo, resourceBundle.getText("onlyNoCons"), 2), _defineProperty(_RBGTwo, resourceBundle.getText("anyCons"), 3), _RBGTwo),
        RBGThree: (_RBGThree = {}, _defineProperty(_RBGThree, resourceBundle.getText("mix"), true), _defineProperty(_RBGThree, resourceBundle.getText("singlePool"), false), _RBGThree)
      };
    },
    ...
    onConfirmDialog: function onConfirmDialog(event, setInfoData) {
      ...
      this.setInfoNoResource = "(LGNUM='".concat(warehouseNumber, "',TROLLEY='',SPWR=").concat(this.radioButtonGroupEnums.RBGOne[rbgFirstSprw], ",AAREA='").concat(activityArea.getValue(), "',CONSOLIDATE='").concat(this.radioButtonGroupEnums.RBGTwo[rbgSecondConsolidate], "',POOL_MIX=").concat(this.radioButtonGroupEnums.RBGThree[rbgThirdPoolMix], ")");
      var setInfo = setInfoData ? setInfoData : "(LGNUM='".concat(warehouseNumber, "',TROLLEY='").concat(dataInputTrolley.getValue(), "',SPWR=").concat(this.radioButtonGroupEnums.RBGOne[rbgFirstSprw], ",AAREA='").concat(activityArea.getValue(), "',CONSOLIDATE='").concat(this.radioButtonGroupEnums.RBGTwo[rbgSecondConsolidate], "',POOL_MIX=").concat(this.radioButtonGroupEnums.RBGThree[rbgThirdPoolMix], ")");
      ...
      oModel.read("/StartPopupCollection" + setInfo, {
        ...
        success: function success(data) {
          _this2.isResource = !_this2.radioButtonGroupEnums.RBGOne[rbgFirstSprw];
    ...
    onShowKeyboard: function (oEvent) {
			...
			if (this.getView().byId("scanDestPosInput")) {
				this.getView().byId("scanDestPosInput").setEditable(false);
				this.getView().byId("scanDestPosInput").setEditable(true);
			}
