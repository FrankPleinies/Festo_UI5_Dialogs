sap.ui.define([
	...
	return Controller.extend("y20_outb_pcon.controller.Base", {
		...
		*/
		...
		/**
		* onCloseRackCoordinateDialog
		* Close rack coordinate dialog
		*/
	    onCloseRackCoordinateDialog: function onCloseRackCoordinateDialog() {
		      this.byId("dialogRackCoordinates").close();
		},
		...
		*/	
		getRackCoordinateDialogs: function () {
			// created dialog for Rack Coordinates
			if (!this._oRackCoordinateDialog) {
				this._oRackCoordinateDialog = sap.ui.xmlfragment(this.getView().getId(),
					"y20_outb_pcon.view.RackCoordinatesDialog", this);
				this.getView().addDependent(this._oRackCoordinateDialog);
			}
			return this._oRackCoordinateDialog;
		},
		...
		_getMessageDialog: function () {
			...
			if (!this._oMessageDialog) {
				this._oMessageDialog = sap.ui.xmlfragment(this.getView().getId(),
					"y20_outb_pcon.view.MessageDialog", this);
		...
		_getMessagePopover: function () {
			...
			if (!this._oMessagePopover) {
				this._oMessagePopover = sap.ui.xmlfragment(this.getView().getId(),
					"y20_outb_pcon.view.MessagePopover", this);
